...
<body style="margin:0">
   ...
   <%@include file="homeheader.jsp" %>
    ...
    <div class="container">
  		...
  		<div class="top-right"><p class="blink blink-two" style="color:red;font-size:20px;">Convinced? Try it yourself</p>
  		 <p><i>New user? <a href="signup.jsp">Signup</a></i></p>
  		 <p><i>Existing user? <a href="login.jsp">Login</a></i></p>
