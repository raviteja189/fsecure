...
<title>FSecure</title>
<link rel="stylesheet" type="text/css" href="aesdecryption.css"> 
...
<div class="row">
  ...
  <div class="column right" >
    <div class="login">
    <h1><div><span style="color:#ff0000;">A</span><span style="color:#db1a24;">e</span><span style="color:#b63449;">s</span><span style="color:#924e6d;"> </span><span style="color:#6d6992;">D</span><span style="color:#4983b6;">e</span><span style="color:#249ddb;">c</span><span style="color:#00b7ff;">r</span><span style="color:#2bc3d5;">y</span><span style="color:#55cfaa;">p</span><span style="color:#80db80;">t</span><span style="color:#aae755;">i</span><span style="color:#d5f32b;">o</span><span style="color:#ffff00;">n</span></div></h1>
    <form action="AesDecryption" method="post" enctype="multipart/form-data">
